...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_next_link__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__style_theme__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__style_keyframes__ = __webpack_require__(17);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var dotSize = 15;
var eatAnimSize = 35;
var dotWrapBottom = 20;

var style = _objectSpread({}, __WEBPACK_IMPORTED_MODULE_6__style_theme__["shadows"].text, {
  height: '100%',
  overflow: 'hidden',
  position: 'relative',
  '& .info': _objectSpread({
    fontSize: 20
  }, __WEBPACK_IMPORTED_MODULE_6__style_theme__["flexColCenter"], {
    justifyContent: 'center',
    height: "calc(100% - ".concat(eatAnimSize, "px)"),
    '& p': {
      padding: '2px 0',
      ':nth-child(1)': {
        fontSize: 30
  ...
  '& .dotsWrap': {
    ...
    display: 'flex',
    justifyContent: 'center',
    margin: "0 auto ".concat(dotWrapBottom, "px"),
    '& .dot': {
      margin: '0 auto',
      padding: "0 ".concat(dotSize / 2)
    }
  },
  '& .eatAnim': {
    position: 'absolute',
    ...
    '& .half': {
      ...
      '& div': {
        background: __WEBPACK_IMPORTED_MODULE_6__style_theme__["colors"].yellow,
        height: eatAnimSize,
        width: eatAnimSize,
        borderRadius: '100%'
      },
      ':nth-child(1)': {
        ...
        animation: "".concat(__WEBPACK_IMPORTED_MODULE_7__style_keyframes__["c" /* chewTopAnim */], " 600ms ease-in-out infinite"),
        '& i': {
          position: 'absolute',
          top: eatAnimSize * 0.2,
      ...
      ':nth-child(2)': {
        ...
        animation: "".concat(__WEBPACK_IMPORTED_MODULE_7__style_keyframes__["a" /* chewBotAnim */], " 600ms ease-in-out infinite")
      }
    }
  } // .eatAnim
...
function (_Component) {
  ...
  function Error() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "dotSize", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: 20
    }), Object.defineProperty(_assertThisInitialized(_this), "eatSpeedFactor", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: 0.35
    }), Object.defineProperty(_assertThisInitialized(_this), "checkEatSpeed", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: _this.eatSpeedFactor * 100
    }), Object.defineProperty(_assertThisInitialized(_this), "checkDots", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var _assertThisInitialize = _assertThisInitialized(_this),
            dotSize = _assertThisInitialize.dotSize;

        _this.numDots = Math.floor(window.innerWidth / (dotSize * 2));
        var dots = [];

        for (var i = 0; i < _this.numDots; i++) {
          dots.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", {
            className: "dot",
            key: i
        ...
        _this.setState({
          dots: dots,
          eatSpeed: _this.numDots * _this.eatSpeedFactor
        });

        _this.dots = _this.dotsEl.getElementsByClassName('dot');
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "doEat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        if (_this.dots.length === 0) return;
        var eatLeft = _this.eatEl.offsetLeft + 5;

        for (var i = 0; i < _this.dots.length; i++) {
          var el = _this.dots[i];
          if (el.offsetLeft <= eatLeft) el.style.opacity = 0;else el.style.opacity = 1;
        }

        _this.eatAnim = window.requestAnimationFrame(_this.doEat);
      }
    }), _temp));
  }
  ...
  _createClass(Error, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          dots = _state.dots,
          eatSpeed = _state.eatSpeed;
      var _props = this.props,
          users = _props.users,
          statusCode = _props.statusCode;
      var eatAnimStyle = {
        animation: "".concat(Object(__WEBPACK_IMPORTED_MODULE_7__style_keyframes__["b" /* chewMoveAnim */])(eatAnimSize), " ").concat(eatSpeed, "s linear infinite")
      };
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__comps_Layout__["a" /* default */], {
        ...
        className: "info"
      }, statusCode === 404 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "Page Not Found") : null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "Error: ", statusCode), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_next_link___default.a, {
        href: users.curUser ? '/home' : '/'
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "btn-alt"
      }, "Go Home"))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "dotsWrap",
        ref: function ref(el) {
          return _this2.dotsEl = el;
        }
      }, dots), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "eatAnim",
        style: eatAnimStyle,
        ref: function ref(el) {
          return _this2.eatEl = el;
        }
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "half"
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["connect"])(function (_ref3) {
  var users = _ref3.users;
  return {
    users: users
  };
