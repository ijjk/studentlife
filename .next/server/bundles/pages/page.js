...
var images = __WEBPACK_IMPORTED_MODULE_0__config__["allowedExts"].images,
    other = __WEBPACK_IMPORTED_MODULE_0__config__["allowedExts"].other;
var prettyFileSize = Math.floor(__WEBPACK_IMPORTED_MODULE_0__config__["maxFileSize"] / (1000 * 1000)) + 'MB';
...
var invalidType = function invalidType(imageOnly) {
  var allowed = imageOnly ? images : images.concat(other);
  return getError("File type is invalid. Allowed types are ".concat(allowed.join(', '), "."));
};

var checkFile = function checkFile(_ref) {
  var file = _ref.file,
      customExtension = _ref.customExtension,
      imageOnly = _ref.imageOnly,
      previewCb = _ref.previewCb;
  var name = file.name,
      size = file.size;

  if (size > __WEBPACK_IMPORTED_MODULE_0__config__["maxFileSize"]) {
    return getError("File exceeds max file size of ".concat(prettyFileSize));
  }

  if (name.indexOf('.') < 0) {
    return getError("File name does not contain a file extension (e.g. .jpg, .png)");
  }

  var extension = name.split('.').pop().toLowerCase();

  if (customExtension) {
    return getError(extension === customExtension ? null : "File type is invalid. Expected .".concat(customExtension));
  }

  var isImage = images.indexOf(extension) > -1;
...
/* harmony default export */ __webpack_exports__["a"] = (checkFile);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_glamor__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_checkFile__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__redux_actions__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_theme__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__style_keyframes__ = __webpack_require__(17);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var style = {
  ...
  overflow: 'hidden',
  position: 'relative',
  maxWidth: __WEBPACK_IMPORTED_MODULE_5__style_theme__["sizes"].maxBlockWidth,
  border: "1px dotted ".concat(__WEBPACK_IMPORTED_MODULE_5__style_theme__["colors"].blackFg),
  '& .select': _objectSpread({}, __WEBPACK_IMPORTED_MODULE_5__style_theme__["flexColCenter"], {
    textAlign: 'center',
    justifyContent: 'center',
    '& input': {
      display: 'none'
  ...
  '& .eatAnim': {
    ...
    animation: "".concat(Object(__WEBPACK_IMPORTED_MODULE_6__style_keyframes__["b" /* chewMoveAnim */])(60), " 2.5s ease-in-out infinite"),
    '& .half': {
      width: 60,
      height: 30,
      overflow: 'hidden',
      ...
      '& div': {
        ...
        height: 60,
        borderRadius: 60,
        background: __WEBPACK_IMPORTED_MODULE_5__style_theme__["colors"].yellow
      },
      ':nth-child(1)': {
        position: 'relative',
        animation: "".concat(__WEBPACK_IMPORTED_MODULE_6__style_keyframes__["c" /* chewTopAnim */], " 600ms ease-in-out infinite"),
        '& i': {
          top: 10,
          left: 24,
          width: 8,
      ...
      ':nth-child(2)': {
        animation: "".concat(__WEBPACK_IMPORTED_MODULE_6__style_keyframes__["a" /* chewBotAnim */], " 600ms ease-in-out infinite")
      }
    }
  }
};
...
/*#__PURE__*/
function (_Component) {
  _inherits(FileDropBox, _Component);

  function FileDropBox() {
    var _this;

    _classCallCheck(this, FileDropBox);

    _this = _possibleConstructorReturn(this, (FileDropBox.__proto__ || Object.getPrototypeOf(FileDropBox)).call(this));
    Object.defineProperty(_assertThisInitialized(_this), "doFileCheck", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(file) {
        var _this$props = _this.props,
            checkFileParams = _this$props.checkFileParams,
            onFileChange = _this$props.onFileChange;

        if (file) {
          var check = Object(__WEBPACK_IMPORTED_MODULE_3__util_checkFile__["a" /* default */])(_objectSpread({}, checkFileParams, {
            file: file
          }));

          if (check.error) {
            return Object(__WEBPACK_IMPORTED_MODULE_4__redux_actions__["_88" /* setDialog */])({
              title: 'Error...',
              message: check.error,
              button1Txt: 'OK',
              button2Txt: null
    ...
    Object.defineProperty(_assertThisInitialized(_this), "handleChange", {
      ...
      value: function value(e) {
        ...
        _this.doFileCheck(file);
      }
    });
    Object.defineProperty(_assertThisInitialized(_this), "handleDrop", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.doFileCheck(files[0]);

        e.preventDefault();
      }
    });
    Object.defineProperty(_assertThisInitialized(_this), "handleDragOver", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "handleDragLeave", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "focusInput", {
      ...
      writable: true,
      value: function value() {
        return _this.fileEl && _this.fileEl.click();
      }
    });
    _this.state = {
      fileIncoming: false
    };
    _this.className = Object(__WEBPACK_IMPORTED_MODULE_2_glamor__["css"])(style);
    return _this;
  }

  _createClass(FileDropBox, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      var fileIncoming = this.state.fileIncoming;
      var _props = this.props,
          style = _props.style,
      ...
      }), !fileIncoming ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "select"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, fileIncoming ? 'incoming!!!!' : message), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
        type: "file",
        onChange: this.handleChange,
        ref: function ref(el) {
          return _this2.fileEl = el;
        }
      }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        onClick: this.focusInput
      }, "Select file")) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "eatAnim"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "half"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", null))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "half"
...
/* harmony default export */ __webpack_exports__["a"] = (FileDropBox);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__redux_actions__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_config__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__util_config__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__util_checkFile__ = __webpack_require__(35);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var styles = {
  ...
  '& .box': _objectSpread({
    width: '100%'
  }, __WEBPACK_IMPORTED_MODULE_3__style_theme__["shadows"].box, {
    margin: 'auto',
    borderRadius: 3
  }, __WEBPACK_IMPORTED_MODULE_3__style_theme__["flexRowCenter"], {
    background: '#ffffff',
    maxWidth: __WEBPACK_IMPORTED_MODULE_3__style_theme__["sizes"].maxBlockWidth
  }),
  // .box
  '& .preview': {
    width: '100%',
  ...
  '& .buttons': _objectSpread({}, __WEBPACK_IMPORTED_MODULE_3__style_theme__["flexRowCenter"], {
    '& button': {
      ...
      '&:disabled': {
        '&:hover, &:active': _objectSpread({}, __WEBPACK_IMPORTED_MODULE_3__style_theme__["shadows"].box)
      }
    }
  }),
  // .buttons
...
function (_Component) {
  ...
  function PostBox() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = PostBox.__proto__ || Object.getPrototypeOf(PostBox)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "handleText", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "handleFile", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
      ...
      value: function value(file) {
        ...
        if (file) {
          var check = Object(__WEBPACK_IMPORTED_MODULE_7__util_checkFile__["a" /* default */])({
            file: file,
            previewCb: _this.previewCb
          });

          if (check.error) {
            _this.fileEl.value = null;
            return Object(__WEBPACK_IMPORTED_MODULE_5__redux_actions__["_88" /* setDialog */])({
              title: 'Error...',
              button1Txt: 'OK',
              button2Txt: null,
              message: check.error
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "previewCb", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "expand", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "stopShrink", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "shrink", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "addFile", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        return _this.fileEl.click();
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "removeFile", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
      ...
      value: function value() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_5__redux_actions__["_37" /* createPost */])({
          text: text,
          file: file
        });
      }
  ...
  _createClass(PostBox, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: Object(__WEBPACK_IMPORTED_MODULE_2_glamor__["css"])(styles)
      }, post.error && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        className: "error"
      }, post.error), function () {
        if (users[users.curUser].restricts.posting) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "Posting is disabled for your account");
        }

        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          onDrop: _this2.handleDrop,
          onMouseDown: _this2.stopShrink,
          ...
          value: text,
          id: "PostBox",
          maxLength: __WEBPACK_IMPORTED_MODULE_6__util_config__["maxPostText"],
          placeholder: "What would you like to post?",
          onBlur: _this2.shrink,
          onFocus: _this2.expand,
        ...
        }), preview && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "preview"
        ...
        }, "Attach file"), filename && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", null, "File: "), filename, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__fortawesome_react_fontawesome___default.a, {
          icon: "trash",
          style: {
            height: 16
          },
          onClick: _this2.removeFile
        })), post.pending ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
          disabled: true
        }, post.progress + '%') : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
...
// CONCATENATED MODULE: ./comps/pages/ModsArea.js





var ModsArea_ModsArea = function ModsArea(_ref) {
  var mods = _ref.mods,
      users = _ref.users,
      newMod = _ref.newMod,
      addMod = _ref.addMod,
      modError = _ref.modError,
      handleMod = _ref.handleMod,
      removeMod = _ref.removeMod,
      modPending = _ref.modPending;
  return external__react__default.a.createElement("div", {
    className: "mods"
  }, external__react__default.a.createElement("div", {
    className: "wrap"
  }, external__react__default.a.createElement("h5", null, "Page moderators"), external__react__default.a.createElement("p", {
    className: "note"
  }, "Note: moderators are allowed to edit the page's name, desc, and thumbnail and post on the page."), external__react__default.a.createElement("div", {
    className: "items"
  }, (!mods || !mods.length) && external__react__default.a.createElement("p", {
    className: "none"
  }, "No moderators have been added yet"), mods && mods.map(function (_ref2) {
    var _id = _ref2._id,
        user = _ref2.user;

    var _ref3 = users[user] || {},
        avatar = _ref3.avatar,
    ...
    }), external__react__default.a.createElement("p", null, "".concat(firstName, " ").concat(lastName, " - @").concat(username)), external__react__default.a.createElement(react_fontawesome__default.a, {
      id: _id,
      "data-user": user,
      icon: "trash",
      style: {
    ...
    htmlFor: "modUser"
  }, "New moderator: "), external__react__default.a.createElement("input", {
    type: "text",
    id: "modUser",
    value: newMod,
    onChange: handleMod,
    ...
    onClick: modPending ? null : addMod
  }, modPending ? external__react__default.a.createElement(Spinner["a" /* default */], {
    size: 18,
    alt: true
  }) : 'Submit'), modError && external__react__default.a.createElement("p", null, modError))));
};

/* harmony default export */ var pages_ModsArea = (ModsArea_ModsArea);
// EXTERNAL MODULE: ./comps/pages/PageThumb.js
var PageThumb = __webpack_require__(23);
...
// CONCATENATED MODULE: ./comps/pages/editPageStyle.js
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
var style = {
  ...
  '& .fields, & .mods': {
    width: '100%',
    margin: '15px auto',
    maxWidth: theme["sizes"].maxBlockWidth + 130
  },
  '& .fields': _objectSpread({
    ...
    '& .field': _objectSpread({
      ...
      '&.btns': _objectSpread({}, theme["flexRowCenter"], {
        '& button': {
          ':nth-child(1)': {
  ...
  '& .mods': {
    ...
    '& .addMod': _objectSpread({}, theme["flexRowCenter"], {
      flexWrap: 'wrap',
      '& label': {
        marginRight: 5
      },
...
/* harmony default export */ var editPageStyle = (style);
// EXTERNAL MODULE: ./util/getError.js
var getError = __webpack_require__(8);

// EXTERNAL MODULE: ./comps/util/FileDropBox.js
var FileDropBox = __webpack_require__(40);

// CONCATENATED MODULE: ./comps/pages/EditPage.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function EditPage__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { EditPage__defineProperty(target, key, source[key]); }); } return target; }

function EditPage__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var EditPage_Field = function Field(_ref) {
  var label = _ref.label,
      name = _ref.name,
      type = _ref.type,
  ...
  return external__react__default.a.createElement("div", {
    className: "field"
  }, label && external__react__default.a.createElement("label", {
    htmlFor: name
  }, label), external__react__default.a.createElement(type === 'textarea' ? 'textarea' : 'input', EditPage__objectSpread({
    name: name,
    id: name,
...
var getPage = function getPage(_ref2) {
  var curPage = _ref2.curPage,
      pages = _ref2.pages;
  return curPage !== 'new' && pages[curPage] ? pages[curPage] : emptyPage;
};

var EditPage_EditPage =
/*#__PURE__*/
function (_Component) {
  ...
  function EditPage(props) {
    ...
    _this = _possibleConstructorReturn(this, (EditPage.__proto__ || Object.getPrototypeOf(EditPage)).call(this, props));

    EditPage__initialiseProps.call(_assertThisInitialized(_this));

    var _getPage = getPage(props),
        name = _getPage.name,
        desc = _getPage.desc,
        thumb = _getPage.thumb;
    ...
    _this.className = Object(external__glamor_["css"])(editPageStyle);
    return _this;
  }
  ...
  _createClass(EditPage, [{
    ...
    value: function render() {
      var _state = this.state,
          desc = _state.desc,
          name = _state.name,
          newMod = _state.newMod,
          changed = _state.changed,
          modError = _state.modError,
          modPending = _state.modPending,
      ...
      var _ref4 = pages[curPage] || {},
          mods = _ref4.mods,
          modsOnly = _ref4.modsOnly,
          thumb = _ref4.thumb,
          pageData = _objectWithoutProperties(_ref4, ["mods", "modsOnly", "thumb"]);

      var isNew = curPage === 'new';
      var numChanged = Object.keys(changed).length;
      ...
      if (previewData) {
        thumbPrev = external__react__default.a.createElement(PageThumb["a" /* default */], {
          src: previewData
        });
      } else {
        thumbPrev = isNew ? external__react__default.a.createElement(react_fontawesome__default.a, {
          icon: "file",
          style: {
            height: 86,
            width: 96,
        ...
        }) : external__react__default.a.createElement(PageThumb["a" /* default */], {
          _id: pages.curPage,
          thumb: thumb
        });
      }
      ...
      return external__react__default.a.createElement("div", {
        className: this.className
      }, isAdmin && !pageData.default && !isNew && external__react__default.a.createElement("div", {
        className: "wrapDel"
      }, external__react__default.a.createElement("button", {
        id: "delete",
        onClick: this.delete
      }, "Delete page")), external__react__default.a.createElement("div", {
        className: "fields"
      }, thumbPrev, external__react__default.a.createElement(FileDropBox["a" /* default */], {
        style: {
          margin: '10px 0'
        },
        ...
        checkFileParams: {
          imageOnly: true,
          previewCb: this.previewThumb
        },
        message: "Drag and drop picture or click below to select page thumbnail"
      }), external__react__default.a.createElement(EditPage_Field, {
        name: "name",
        value: name,
        label: "Page name:",
      ...
      }), Boolean(isNew && changed.thumb && changed.name || !isNew && numChanged) && external__react__default.a.createElement("div", {
        className: "field btns"
      }, external__react__default.a.createElement("button", {
        onClick: this.reset,
        className: "btn-alt"
      }, "Reset"), external__react__default.a.createElement("button", {
        onClick: pending ? null : this.submit
      }, pending ? "".concat(progress, "%") : 'Submit')), error && external__react__default.a.createElement("p", {
        className: "error"
      }, error)), !isNew && modsOnly && isAdmin && external__react__default.a.createElement(pages_ModsArea, {
        mods: mods,
        users: users,
        newMod: newMod,
        modError: modError,
    ...
    value: function getDerivedStateFromProps(_ref5, state) {
      var curPage = _ref5.curPage,
          page = _ref5.page,
          pages = _ref5.pages;

      if (!page.error && !page.pending && state.pending) {
        var _ref6 = pages[curPage] || {
          name: '',
          desc: ''
        },
            name = _ref6.name,
...
var EditPage__initialiseProps = function _initialiseProps() {
  var _this2 = this;
  ...
  Object.defineProperty(this, "handleFileChange", {
    ...
    writable: true,
    value: function value(file) {
      var changed = _this2.state.changed;
      var state = {
        changed: changed,
        file: file
      };
  ...
  Object.defineProperty(this, "handleField", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(e) {
      ...
      _this2.setState((_this2$setState = {}, EditPage__defineProperty(_this2$setState, name, value), EditPage__defineProperty(_this2$setState, "changed", changed), _this2$setState));
    }
  });
  Object.defineProperty(this, "reset", {
    ...
    writable: true,
    value: function value() {
      var _getPage2 = getPage(_this2.props),
          name = _getPage2.name,
          desc = _getPage2.desc;
  ...
  Object.defineProperty(this, "submit", {
    ...
    writable: true,
    value: function value() {
      var curPage = _this2.props.curPage;
      ...
      var toSubmit = {};
      var changedFields = Object.keys(changed);
      if (!changedFields.length) return;
      changedFields.forEach(function (key) {
        return toSubmit[key] = _this2.state[key];
      });
      ...
      Object(actions["_88" /* setDialog */])({
        message: "Are you sure you would like to ".concat(isNew ? 'create' : 'update', " this page?"),
        button1Act: function button1Act() {
          Object(actions["_93" /* updatePage */])(toSubmit).then(function (id) {
            return router__default.a.push('/page?id=' + id);
          });
        }
      });
    }
  });
  Object.defineProperty(this, "previewThumb", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(previewData) {
      _this2.setState({
        previewData: previewData
      });
    }
  });
  Object.defineProperty(this, "handleMod", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(e) {
  ...
  Object.defineProperty(this, "addMod", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      var _this2$state2 = _this2.state,
          newMod = _this2$state2.newMod,
          modPending = _this2$state2.modPending;
      if (modPending) return;
      newMod = newMod.trim();
      if (!newMod) return;
      Object(actions["_88" /* setDialog */])({
        message: "Are you sure you want to make ".concat(newMod, " a moderator on this page?"),
        button1Act: function button1Act() {
          _this2.setState({
            modPending: true,
            modError: null
          ...
          Object(actions["_34" /* createMod */])(newMod).then(function () {
            _this2.setState({
              modPending: false,
              newMod: ''
            });
            ...
            _this2.setState({
              modPending: false,
              modError: Object(getError["a" /* default */])(err, 'An error occurred adding the mod')
            });
          });
        }
      });
  ...
  Object.defineProperty(this, "removeMod", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(e) {
      ...
      Object(actions["_88" /* setDialog */])({
        message: "Are you sure you want to remove ".concat(username, " as a moderator?"),
        button1Act: function button1Act() {
          Object(actions["_78" /* removeMod */])(id).catch(function (err) {
            Object(actions["_88" /* setDialog */])({
              title: 'Error...',
              message: Object(getError["a" /* default */])(err, 'An error occurred removing the moderator'),
              button1Txt: 'OK',
              button2Txt: null
            });
          });
  ...
  Object.defineProperty(this, "delete", {
    ...
    value: function value() {
      var curPage = _this2.props.curPage;
      Object(actions["_88" /* setDialog */])({
        message: 'Are you sure you want to delete this page? This will delete all posts too and is permanent.',
        button1Act: function button1Act() {
          Object(actions["_81" /* removePage */])(curPage).then(function () {
            return router__default.a.push('/page');
          }).catch(function (err) {
            Object(actions["_88" /* setDialog */])({
              title: 'Error...',
              message: Object(getError["a" /* default */])(err, 'An error occurred removing the page'),
              button1Txt: 'OK',
              button2Txt: null
            });
          });
  ...
  Object.defineProperty(this, "componentWillUnmount", {
    ...
    writable: true,
    value: function value() {
      return _this2.unmounted = true;
    }
  });
};

/* harmony default export */ var pages_EditPage = __webpack_exports__["a"] = (Object(external__react_redux_["connect"])(function (_ref7) {
  var page = _ref7.page,
      pages = _ref7.pages,
      users = _ref7.users;
  return {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_config__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__util_config__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_next_link__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_next_link___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_next_link__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PageThumb__ = __webpack_require__(23);
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
var PageInfo = function PageInfo(_ref) {
  var canEdit = _ref.canEdit,
      pages = _ref.pages;
  var curPage = pages.curPage;

  var _ref2 = pages[curPage] || {},
      desc = _ref2.desc,
      name = _ref2.name,
      thumb = _ref2.thumb;

  var isNews = curPage === __WEBPACK_IMPORTED_MODULE_4__util_config__["newsPageId"];
  var editUrl = isNews ? '/news?edit' : '/page?id=' + curPage + '&edit';
  if (!thumb) return null;
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
    className: Object(__WEBPACK_IMPORTED_MODULE_1_glamor__["css"])(style)
  }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__PageThumb__["a" /* default */], {
    _id: curPage,
    thumb: thumb
  }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", null, name), canEdit && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_next_link___default.a, {
    href: editUrl,
    passHref: true
  }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a", {
    id: "edit"
  }, ' - Edit'))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, desc)));
};
...
// EXTERNAL MODULE: ./comps/Layout.js + 8 modules
var Layout = __webpack_require__(31);

// EXTERNAL MODULE: ./comps/posts/PostBox.js
var PostBox = __webpack_require__(42);

// EXTERNAL MODULE: ./comps/pages/PageInfo.js
var PageInfo = __webpack_require__(48);

// EXTERNAL MODULE: ./comps/pages/EditPage.js + 2 modules
var EditPage = __webpack_require__(43);

// EXTERNAL MODULE: ./comps/posts/PostsArea.js + 9 modules
var PostsArea = __webpack_require__(38);
...
// CONCATENATED MODULE: ./comps/pages/ListPages.js
var _div;
  ...
  '& .pages': {
    ...
    '& .items': _objectSpread({
      ...
      '& div': (_div = {
        ...
        cursor: 'pointer',
        opacity: 0,
        animation: "".concat(keyframes["f" /* growIn */], " 150ms ease-in-out forwards"),
        ':hover': {
          '& img': {
            boxShadow: '3px 6px 9px rgba(0, 0, 0, 0.3)'
          }
      ...
      }, _defineProperty(_div, theme["media"].lessThan(400), {
        width: 115,
        '& img': {
          width: 115,
          height: 115
        }
      }), _defineProperty(_div, theme["media"].lessThan(350), {
        width: 100,
        '& img': {
          width: 100,
          height: 100
...
var ListPages_updateSort = function updateSort(e) {
  var sort = e.target.value;
  Object(actions["_45" /* listPages */])({
    sort: sort,
    initial: true
  });
};

var ListPages_ListPages =
/*#__PURE__*/
function (_Component) {
  _inherits(ListPages, _Component);
  ...
  function ListPages() {
    ...
    _classCallCheck(this, ListPages);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ListPages.__proto__ || Object.getPrototypeOf(ListPages)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _createClass(ListPages, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          pages = _props.pages,
          users = _props.users;
      var error = pages.error,
          hasMore = pages.hasMore,
          pending = pages.pending,
          sort = pages.sort,
          toList = pages.toList;
      var idxOffset = toList.length - numAdded;
      var curUser = users[users.curUser] || {};
      var restricts = curUser.restricts;
      return external__react__default.a.createElement("div", {
        className: Object(external__glamor_["css"])(style)
      }, external__react__default.a.createElement("div", {
        className: "wrapNew"
      }, restricts && !restricts.making_pages ? external__react__default.a.createElement(link__default.a, {
        href: "/new-page"
      }, external__react__default.a.createElement("a", {
        id: "create"
      }, external__react__default.a.createElement("button", null, "Create page"))) : external__react__default.a.createElement("p", null, "Making pages is disabled for your account")), external__react__default.a.createElement("div", null, external__react__default.a.createElement("label", {
        htmlFor: "sort"
      }, "Sort pages: "), external__react__default.a.createElement("select", {
        id: "sort",
        value: sort,
        onChange: ListPages_updateSort
        ...
        value: "name:-1"
      }, 'Name Z -> A'))), external__react__default.a.createElement("div", {
        className: "pages"
      }, external__react__default.a.createElement("div", {
        className: "items"
      }, toList.map(function (_id, idx) {
        var _ref2 = pages[_id] || {},
            name = _ref2.name,
            thumb = _ref2.thumb;
        ...
        return external__react__default.a.createElement(link__default.a, {
          ...
          src: config["uploadsUrl"] + thumb,
          alt: "page thumb"
        }), external__react__default.a.createElement("h6", {
          className: "name"
        }, name))));
      })), !pending && !error && !toList.length && external__react__default.a.createElement("p", {
        className: "error"
      }, "There are no pages yet"), pending && external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 36,
        className: "pending"
      }), error && !pending && external__react__default.a.createElement("p", {
        className: "error"
      }, error), hasMore && !pending && external__react__default.a.createElement("button", {
        className: "moreBtn",
        onClick: function onClick() {
          return Object(actions["_45" /* listPages */])({});
        }
      }, "Load more")));
    }
  }], [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      var numPrev = state.numPrev;
      var numCur = props.pages.toList.length;
...
/* harmony default export */ var pages_ListPages = (Object(external__react_redux_["connect"])(function (_ref3) {
  var pages = _ref3.pages,
      users = _ref3.users;
  return {
    pages: pages,
...
// EXTERNAL MODULE: ./util/withLoginReload.js
var withLoginReload = __webpack_require__(34);
  ...
  page__createClass(Page, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          pages = _props.pages,
          users = _props.users;
      var pageFound = Boolean(pages[page]);

      var _ref = users[users.curUser] || {},
          isAdmin = _ref.isAdmin;

      var _ref2 = pages[page] || {},
          createdBy = _ref2.createdBy;

      var canEdit = isAdmin || createdBy === users.curUser;
      var sharedProps = {
        canEdit: canEdit
      };
      return external__react__default.a.createElement(Layout["a" /* default */], {
        restrict: true
      }, pageFound && editMode && external__react__default.a.createElement(EditPage["a" /* default */], _extends({}, sharedProps, {
        curPage: page
      })), pageFound && !editMode && external__react__default.a.createElement("div", null, external__react__default.a.createElement(PageInfo["a" /* default */], sharedProps), external__react__default.a.createElement(PostBox["a" /* default */], {
        page: page
      }), external__react__default.a.createElement(PostsArea["a" /* default */], _extends({}, sharedProps, {
        page: page
      }))), !pageFound && page && external__react__default.a.createElement("p", {
        className: "errMsg"
      }, "Page could not be found"), !page && external__react__default.a.createElement(pages_ListPages, null));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = _asyncToGenerator(
      /*#__PURE__*/
      regenerator__default.a.mark(function _callee(_ref3) {
        var query, props, id;
        return regenerator__default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 8;
                return Object(actions["_89" /* setPage */])(id);
...
/* harmony default export */ var pages_page = __webpack_exports__["default"] = (Object(withLoginReload["a" /* default */])(Object(external__react_redux_["connect"])(function (_ref4) {
