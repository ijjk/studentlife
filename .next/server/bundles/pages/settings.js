...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__comps_user_Avatar__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__comps_util_FileDropBox__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__redux_actions__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__util_getError__ = __webpack_require__(8);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var style = {
  padding: 10,
  '& .info': _objectSpread({}, __WEBPACK_IMPORTED_MODULE_3__style_theme__["flexRowCenter"], {
    flexWrap: 'wrap',
    alignItems: 'flex-start',
    '& .avatar': {
      width: 72,
  ...
  '& .fields': {
    ...
    '& input': {
      ...
      background: 'none',
      padding: '5px 8px',
      borderBottom: "1px solid ".concat(__WEBPACK_IMPORTED_MODULE_3__style_theme__["colors"].blackFg)
    },
    '& button:nth-child(1)': {
...
function (_Component) {
  ...
  function Settings(props) {
    ...
    _this = _possibleConstructorReturn(this, (Settings.__proto__ || Object.getPrototypeOf(Settings)).call(this, props));

    _initialiseProps.call(_assertThisInitialized(_this));

    var users = props.users;
    var username = users[users.curUser].username;
    _this.state = {
      file: null,
      changes: {},
      error: null,
  ...
  _createClass(Settings, [{
    ...
    value: function render() {
      ...
      var users = this.props.users;
      var curUser = users.curUser,
          avatarProgress = users.avatarProgress,
          avatarError = users.avatarError;

      var _ref = users[curUser] || {},
      ...
      if (restricts && restricts.updating_profile) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__comps_Layout__["a" /* default */], {
          restrict: true
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__comps_Layout__["a" /* default */], {
        ...
        className: "info"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__comps_user_Avatar__["a" /* default */], _extends({
        avatar: avatar
      }, {
        src: previewData,
        className: "avatar"
      })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "".concat(firstName, " ").concat(lastName, " - @").concat(username))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__comps_util_FileDropBox__["a" /* default */], {
        ...
        checkFileParams: {
          imageOnly: true,
          previewCb: this.previewAvatar
        },
        message: "Drag and drop picture or click below to select avatar"
      }), avatar && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wrap"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
      ...
      }, "Remove avatar")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wrap fields"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", {
        htmlFor: "username"
      }, "New username: "), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
        type: "text",
        id: "username",
        maxLength: "16",
      ...
      })), Object.keys(changes).length > 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "btn-alt",
        onClick: this.reset
      }, "Reset"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        onClick: avatarProgress ? null : this.submit
      }, avatarProgress ? avatarProgress + '%' : 'Submit')), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, (avatarError || error) && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, avatarError || error))));
    }
  }]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "handleFile", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(file) {
      var changes = _this2.state.changes;
      var state = {};
  ...
  Object.defineProperty(this, "previewAvatar", {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  Object.defineProperty(this, "removeAvatar", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_88" /* setDialog */])({
        message: 'Are you sure you want to delete your avatar?',
        button1Act: function button1Act() {
          return Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_73" /* removeAvatar */])().catch(function (err) {
            Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_88" /* setDialog */])({
              title: 'Error...',
              message: Object(__WEBPACK_IMPORTED_MODULE_8__util_getError__["a" /* default */])(err, 'An error occurred removing avatar'),
              button1Txt: 'OK',
              button2Txt: null
            });
          });
  ...
  Object.defineProperty(this, "handleField", {
    ...
    value: function value(e) {
      ...
      _this2.setState((_this2$setState = {}, _defineProperty(_this2$setState, key, val), _defineProperty(_this2$setState, "changes", changes), _this2$setState));
    }
  });
  Object.defineProperty(this, "reset", {
    ...
    value: function value() {
      ...
      fields.forEach(function (f) {
        return toReset[f] = user[f];
      });

      _this2.setState(toReset);
    }
  });
  Object.defineProperty(this, "submit", {
    ...
    value: function value() {
      ...
      var _this2$state = _this2.state,
          changes = _this2$state.changes,
          file = _this2$state.file;
      changes = _objectSpread({}, changes);
      var avatar = Boolean(changes.avatar);
      delete changes.avatar;
      var updated = {};
      var keys = Object.keys(changes);
      if (!keys.length && !avatar) return;
      keys.forEach(function (f) {
        return updated[f] = _this2.state[f];
      });

      if (keys.length) {
        Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_97" /* updateUser */])(_objectSpread({
          _id: users.curUser
        }, updated)).then(function () {
          return avatar && Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_31" /* createAvatar */])(file);
        }).then(function () {
          return _this2.reset();
        }).catch(function (err) {
          Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_88" /* setDialog */])({
            title: 'Error...',
            message: Object(__WEBPACK_IMPORTED_MODULE_8__util_getError__["a" /* default */])(err, 'An error occurred updating settings'),
            button1Txt: 'OK',
            button2Txt: null
          });
        });
      } else {
        Object(__WEBPACK_IMPORTED_MODULE_7__redux_actions__["_31" /* createAvatar */])(file).then(function () {
          return _this2.reset();
        });
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_2_react_redux__["connect"])(function (_ref2) {
  var users = _ref2.users;
  return {
    users: users
  };
