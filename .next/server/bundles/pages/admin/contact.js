...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__comps_Layout__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__util_getDate__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__fortawesome_react_fontawesome__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__fortawesome_react_fontawesome___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__fortawesome_react_fontawesome__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__comps_AdminRestrict__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__util_withLoginReload__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__util_getError__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__comps_Spinner__ = __webpack_require__(19);
...
var style = {
  ...
  margin: 'auto',
  '& .delByRange': _objectSpread({
    margin: '10px 0 40px'
  }, __WEBPACK_IMPORTED_MODULE_5__style_theme__["flexRowCenter"], {
    flexWrap: 'wrap',
    '& h6': {
      width: '100%',
      marginBottom: 8
    ...
    '& input': {
      ...
      padding: '0 4px',
      background: 'none',
      borderBottom: "1px solid ".concat(__WEBPACK_IMPORTED_MODULE_5__style_theme__["colors"].blackFg)
    },
    '& button': {
  ...
  '& .msg': _objectSpread({
    ...
    width: '100%',
    borderRadius: 4
  }, __WEBPACK_IMPORTED_MODULE_5__style_theme__["shadows"].box, {
    margin: '15px 0',
    position: 'relative',
    background: '#ffffff',
    padding: '2px 8px 4px',
    animation: "".concat(__WEBPACK_IMPORTED_MODULE_4__style_keyframes__["f" /* growIn */], " 225ms ease-in-out forwards"),
    '& svg': {
      position: 'absolute',
      top: 5,
      right: 5,
...
function (_Component) {
  ...
  function Contact() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Contact.__proto__ || Object.getPrototypeOf(Contact)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      writable: true,
      value: function value() {
        return Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_48" /* loadContact */])({});
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "removeMsg", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        var id = e.currentTarget.id;
        Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_88" /* setDialog */])({
          message: 'Are you sure you want to permanently delete this message?',
          button1Act: function button1Act() {
            Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_76" /* removeContact */])(id).catch(function (err) {
              Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(__WEBPACK_IMPORTED_MODULE_12__util_getError__["a" /* default */])(err, 'An error occurred deleting message'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "removeByRange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        if (!from || !to) return;
        from = Object(__WEBPACK_IMPORTED_MODULE_8__util_getDate__["b" /* getDateFromVal */])(from).getTime();
        to = Object(__WEBPACK_IMPORTED_MODULE_8__util_getDate__["b" /* getDateFromVal */])(to).getTime();
        Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_88" /* setDialog */])({
          message: "Are you sure you want to permanently delete messages received between \n      ".concat(Object(__WEBPACK_IMPORTED_MODULE_8__util_getDate__["a" /* default */])(from), " ").concat(Object(__WEBPACK_IMPORTED_MODULE_8__util_getDate__["a" /* default */])(to), "?"),
          button1Act: function button1Act() {
            Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_77" /* removeContactRange */])(from, to).catch(function (err) {
              Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(__WEBPACK_IMPORTED_MODULE_12__util_getError__["a" /* default */])(err, 'An error occurred removing messages'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
  ...
  _createClass(Contact, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var tstDate = document.createElement('input');
      tstDate.setAttribute('type', 'date');

      if (tstDate.type !== 'date') {
        this.setState({
          dateDelNotSupprted: true
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _state = this.state,
          numAdded = _state.numAdded,
          dateDelNotSupprted = _state.dateDelNotSupprted;
      var error = contact.error,
          hasMore = contact.hasMore,
          ids = contact.ids,
          pending = contact.pending;
      var idxOffset = ids.length - numAdded;
      var noMsgs = !ids.length && !pending && !hasMore;
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__comps_Layout__["a" /* default */], {
        restrict: true
      }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__comps_AdminRestrict__["a" /* default */], null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h5", {
        style: {
          padding: '10px 0 0 10px'
        }
      }, "Contact messages"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        className: Object(__WEBPACK_IMPORTED_MODULE_2_glamor__["css"])(style)
      }, !noMsgs && !dateDelNotSupprted && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        className: "delByRange"
      }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h6", null, "Delete messages"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("label", {
        htmlFor: "from"
      }, "From:"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("input", {
        type: "date",
        id: "from"
        ...
        htmlFor: "to"
      }, "To:"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("input", {
        type: "date",
        id: "to"
      })), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", {
        onClick: this.removeByRange
      }, "Delete")), ids.map(function (id, idx) {
        var _contact$id = contact[id],
            email = _contact$id.email,
            msg = _contact$id.msg,
            name = _contact$id.name,
            createdAt = _contact$id.createdAt;
        ...
        }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__fortawesome_react_fontawesome___default.a, {
          icon: "trash",
          id: id,
          onClick: _this2.removeMsg
        }), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", null, "Name:"), name), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", null, "Email:"), email), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", null, "Sent:"), Object(__WEBPACK_IMPORTED_MODULE_8__util_getDate__["a" /* default */])(createdAt)), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("span", null, "Message:"), msg));
      }), noMsgs && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        className: "errMsg"
      }, "There are no messages yet"), error && !pending && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        className: "error"
      }, error), pending && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__comps_Spinner__["a" /* default */], {
        size: 36
      }), hasMore && !pending && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", {
        onClick: pending ? null : this.loadMore
      }, "Load more"))));
    }
  }], [{
    key: "getInitialProps",
    ...
    value: function getDerivedStateFromProps(_ref2, state) {
      ...
      var numCur = contact.ids.length;

      if (numCur !== numPrev) {
        if (numCur === 0 && !contact.pending && contact.hasMore) {
          Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions__["_48" /* loadContact */])({});
        }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_11__util_withLoginReload__["a" /* default */])(Object(__WEBPACK_IMPORTED_MODULE_3_react_redux__["connect"])(function (_ref3) {
