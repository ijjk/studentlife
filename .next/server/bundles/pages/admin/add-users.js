...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__style_theme__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__redux_actions__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_papaparse__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_getError__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__fortawesome_react_fontawesome__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__comps_AdminRestrict__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__comps_util_FileDropBox__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_virtualized_dist_commonjs_List__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_virtualized_dist_commonjs_List___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_react_virtualized_dist_commonjs_List__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_virtualized_dist_commonjs_AutoSizer__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_virtualized_dist_commonjs_AutoSizer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_react_virtualized_dist_commonjs_AutoSizer__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var rowWidth = 189 * 5 + 145 * 4 + 30;
var rowHeight = 30; // 18px + 12px margin-bottom
...
var style = {
  ...
  '& .wrapRows': _defineProperty({
    ...
    display: 'flex',
    flexDirection: 'column',
    maxWidth: "calc(100vw - ".concat(__WEBPACK_IMPORTED_MODULE_2__style_theme__["sizes"].navWidth, "px - 20px)")
  }, __WEBPACK_IMPORTED_MODULE_2__style_theme__["media"].lessThan(__WEBPACK_IMPORTED_MODULE_2__style_theme__["sizes"].mobileBreak), {
  ...
  '& .row': _objectSpread({
    marginBottom: 12
  }, __WEBPACK_IMPORTED_MODULE_2__style_theme__["flexRowCenter"], {
    width: rowWidth,
    '& *': {
      width: 175,
      marginRight: 10
    ...
    '& input[type="text"], & input[type="email"]': {
      ...
      border: 'none',
      background: 'none',
      borderBottom: "1px solid ".concat(__WEBPACK_IMPORTED_MODULE_2__style_theme__["colors"].blackFg)
    },
    '& input[type="checkbox"]': {
      width: 145,
      cursor: 'pointer'
...
var fields = Object.keys(emptyRow);
var placeholders = ['Email', 'Password', 'First name', 'Last name', 'Username', 'Is admin', 'Can post', 'Can make pages', 'Can update profile'];

var AddUsers =
/*#__PURE__*/
function (_Component) {
  _inherits(AddUsers, _Component);
  ...
  function AddUsers() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = AddUsers.__proto__ || Object.getPrototypeOf(AddUsers)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
        rows: [_objectSpread({}, emptyRow)],
        fileError: null,
        submitError: null,
        submitProgress: 0,
        submitPending: false
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "addRow", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        return _this.setState({
          rows: _this.state.rows.concat(_objectSpread({}, emptyRow))
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "removeRow", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        var rows = _this.state.rows;
        var idx = typeof e === 'number' ? e : e.currentTarget.id;
        rows.splice(idx, 1);
        if (!rows.length) rows.push(_objectSpread({}, emptyRow));
      ...
      enumerable: true,
      writable: true,
      value: function value(rows, total) {
        if (!rows.length || _this.unmounted) return Promise.resolve();

        var _rows$pop = rows.pop(),
            idx = _rows$pop.idx,
            email = _rows$pop.email,
            password = _rows$pop.password,
            firstName = _rows$pop.firstName,
            lastName = _rows$pop.lastName,
            username = _rows$pop.username,
            admin = _rows$pop.admin,
            restricts = _objectWithoutProperties(_rows$pop, ["idx", "email", "password", "firstName", "lastName", "username", "admin"]);

        var toRestrict;
        var posting = restricts.posting,
            making_pages = restricts.making_pages,
            updating_profile = restricts.updating_profile;
        var doRestricts = !posting || !making_pages || !updating_profile;
        var user = {
          email: email,
          password: password,
          firstName: firstName,
        ...
        var numDone = total - rows.length;
        var newIdx = idx - (numDone - 1);
        return Object(__WEBPACK_IMPORTED_MODULE_3__redux_actions__["_40" /* createUser */])(user).then(function (_ref2) {
          var _id = _ref2._id;
          return doRestricts && Object(__WEBPACK_IMPORTED_MODULE_3__redux_actions__["_39" /* createRestrict */])(_objectSpread({}, toRestrict, {
            _id: _id
          }));
        }).then(function () {
          if (_this.unmounted) return;

          _this.removeRow(newIdx);

          var submitProgress = Math.round(numDone / total * 100);

          _this.setState({
            submitProgress: submitProgress
          });
        }).then(function () {
          return _this.addUser(rows, total);
        }).catch(function (err) {
          _this.setState({
            submitPending: false,
            submitError: "Error adding users at row ".concat(newIdx + 1, " ") + Object(__WEBPACK_IMPORTED_MODULE_6__util_getError__["a" /* default */])(err, '')
          });
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "submitUsers", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        var hasEmpty = _this.state.rows.some(function (row, idx) {
          rows.push(_objectSpread({}, row, {
            idx: idx
          }));
          return fields.some(function (field, idx) {
            var missing = row[field] === emptyRow[field] && idx < 4;
        ...
        if (hasEmpty) {
          return Object(__WEBPACK_IMPORTED_MODULE_3__redux_actions__["_88" /* setDialog */])({
            title: 'Error...',
            message: "Row ".concat(rows.length, " is missing \"").concat(missingField, "\" value. Please enter it or delete the row to continue."),
            button1Txt: 'OK',
            button2Txt: null
          });
        }
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3__redux_actions__["_88" /* setDialog */])({
          message: "Are you sure you want to add ".concat(rows.length, " user").concat(s, "? You will not be able to navigate away from this page or else users might fail to be added. Note: Adding a lot of users can take a while"),
          button1Act: function button1Act() {
            ...
            _this.addUser(rows.reverse(), rows.length).then(function () {
              _this.setState({
                submitPending: false
              });
            });
      ...
      value: function value(e) {
        ...
        var _e$target$closest = e.target.closest('div'),
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "handleUsers", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "usersFileError", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(fileError) {
        return _this.setState({
          fileError: fileError
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "handleUsersFile", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(file) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_papaparse___default.a.parse(file, {
          skipEmptyLines: true,
          complete: _this.handleUsers,
          error: _this.usersFileError
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "rowRenderer", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(_ref4) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          ...
          key: key,
          id: index
        }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__fortawesome_react_fontawesome___default.a, {
          icon: "trash",
          id: index,
          onClick: _this.removeRow
          ...
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', elProps);
        }));
      }
    }), _temp));
  }
  ...
  _createClass(AddUsers, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          submitPending = _state.submitPending,
          submitProgress = _state.submitProgress;
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__comps_Layout__["a" /* default */], {
        className: Object(__WEBPACK_IMPORTED_MODULE_1_glamor__["css"])(style),
        restrict: true
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__comps_AdminRestrict__["a" /* default */], null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h5", null, "Add users"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wrapRows"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "row"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", null), fields.map(function (field, idx) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h6", {
          key: field,
          className: typeof emptyRow[field] === 'string' ? null : 'check'
        }, placeholders[idx]);
      })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wrapSizer"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_react_virtualized_dist_commonjs_AutoSizer___default.a, null, function (_ref5) {
        var height = _ref5.height;
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_react_virtualized_dist_commonjs_List___default.a, {
          height: height,
          width: rowWidth,
          rowHeight: rowHeight,
        ...
        className: "btns"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, rows.length, " rows"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "btn-alt",
        onClick: this.addRow
      }, "Add row"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        onClick: submitPending ? null : this.submitUsers
      }, submitPending ? submitProgress + '%' : 'Submit users')), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, submitError && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        className: "err"
      }, submitError)), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "hint"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, 'Note: To create the csv file you can start with an excel file and just save it as csv. For the "admin", "posting", "make pages", and "update profile" fields just enter "yes" or "no" without the " or leave empty to use default of (no, yes, yes, yes). If you get a message about styling or formatting not able to be saved in this format just say OK. You do not need to add a header row with email, username... in the csv file you just need to use the same order as the table above.')), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, fileError && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        className: "errMsg"
      }, fileError)), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__comps_util_FileDropBox__["a" /* default */], {
        style: {
          margin: '15px auto'
        },
...
/* harmony default export */ __webpack_exports__["default"] = (AddUsers);
