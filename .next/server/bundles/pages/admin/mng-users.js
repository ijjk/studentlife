...
// CONCATENATED MODULE: ./util/adminReload.js
// check if isAdmin state has changed if so
// return true to cause getInitialProps to reload
var adminReload = function adminReload(props, prevProps) {
  if (!prevProps.users.curUser || !props.users.curUser) return;
  var prevUsers = prevProps.users;
  var prevIsAdmin = prevUsers[prevUsers.curUser].isAdmin;
  var users = props.users;
  var isAdmin = users[users.curUser].isAdmin;
  if (!prevIsAdmin && isAdmin) return true;
};

/* harmony default export */ var util_adminReload = (adminReload);
// EXTERNAL MODULE: ./comps/user/Avatar.js
var Avatar = __webpack_require__(18);

// EXTERNAL MODULE: ./comps/AdminRestrict.js
var AdminRestrict = __webpack_require__(39);

// EXTERNAL MODULE: external "react-virtualized/dist/commonjs/List"
var List_ = __webpack_require__(46);
var List__default = /*#__PURE__*/__webpack_require__.n(List_);

// EXTERNAL MODULE: external "react-virtualized/dist/commonjs/AutoSizer"
var AutoSizer_ = __webpack_require__(47);
var AutoSizer__default = /*#__PURE__*/__webpack_require__.n(AutoSizer_);

// EXTERNAL MODULE: ./util/withLoginReload.js
var withLoginReload = __webpack_require__(34);

// CONCATENATED MODULE: ./pages/admin/mng-users.js
...
var mng_users_style = {
  ...
  '& .filter': _objectSpread({}, theme["flexRowCenter"], {
    '& label': {
      marginRight: 10
    },
    '& input': {
  ...
  '& .item': _objectSpread({
    ...
    borderBottom: "1px solid ".concat(theme["colors"].darkGrey),
    '&.loadMore': {
      borderBottom: 'none',
      '& button': {
        margin: 'auto'
...
var mng_users_MngUsers =
/*#__PURE__*/
function (_Component) {
  _inherits(MngUsers, _Component);
  ...
  function MngUsers() {
    ...
    _classCallCheck(this, MngUsers);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = MngUsers.__proto__ || Object.getPrototypeOf(MngUsers)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "restricts", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: [{
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "handleSetting", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.setState(_defineProperty({}, id, !_this.state[id]));
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "toggleCheck", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "selectAll", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        _this.props.mngUsers.ids.forEach(function (id) {
      ...
      value: function value(e) {
        ...
        clearTimeout(_this.filterTime);
        _this.filterTime = setTimeout(function () {
          Object(actions["_46" /* listUsers */])({
            initial: true,
            filter: filter
          });
        }, 350);
      ...
      writable: true,
      value: function value() {
        return Object(actions["_46" /* listUsers */])({
          filter: _this.state.filter
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "getChecked", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        return Object.keys(_this.state.checked);
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "clearAll", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "getS", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "yesNo", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "onOff", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(val) {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "resetAvatars", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var ids = _this.getChecked();

        var s = _this.getS(ids.length);

        if (!ids.length) return;
        Object(actions["_88" /* setDialog */])({
          message: "Are you sure you want to reset ".concat(ids.length, " user").concat(s, " avatar?"),
          button1Act: function button1Act() {
            ...
            Object(actions["_74" /* removeAvatars */])(ids).then(function () {
              return done();
            }).catch(function (err) {
              done();
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred resetting the avatars'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "submitSettings", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var _this$state = _this.state,
            ...
            making_pages = _this$state.making_pages,
            updating_profile = _this$state.updating_profile;
        ...
        if (!ids.length) return;
        Object(actions["_88" /* setDialog */])({
          message: "Are you sure you want to update ".concat(ids.length, " user").concat(s, " settings to \n                Admin: ").concat(_this.yesNo(admin), ", Posting: ").concat(_this.onOff(posting), ", \n                Making pages: ").concat(_this.onOff(making_pages), ", Updating profile: \n                ").concat(_this.onOff(updating_profile)),
          button1Act: function button1Act() {
            var done = function done() {
              return _this.setState({
                settingsPending: false
            ...
            Object(actions["_96" /* updateSettings */])(ids, {
              admin: admin,
              posting: posting,
              making_pages: making_pages,
              ...
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred updating settings'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "deleteUsers", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        var s = ids.length === 1 ? '' : 's';
        if (!ids.length) return;
        Object(actions["_88" /* setDialog */])({
          message: "Are you sure you want to delete ".concat(ids.length, " user").concat(s, "? This can not be undone and will delete all of the users posts and comments."),
          button1Act: function button1Act() {
            var done = function done() {
              return _this.setState({
                removePending: false
            ...
            Object(actions["_84" /* removeUsers */])(ids).then(function () {
              return done();
            }).catch(function (err) {
              done();
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred removing the user' + s),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
      ...
      value: function value(_ref2) {
        ...
        if (index === mngUsers.ids.length) {
          return external__react__default.a.createElement("div", _extends({
            ...
            className: "item loadMore"
          }), external__react__default.a.createElement("button", {
            onClick: _this.loadMore
          }, "Load more"));
        }

        var _id = mngUsers.ids[index];
        ...
        return external__react__default.a.createElement("div", _extends({
          ...
          onChange: _this.toggleCheck
        }), external__react__default.a.createElement("label", {
          htmlFor: 'check' + _id
        }, external__react__default.a.createElement(Avatar["a" /* default */], _extends({
          avatar: avatar
        }, {
          className: "avatar"
        }))), external__react__default.a.createElement("div", null, external__react__default.a.createElement("p", null, firstName + ' ' + lastName + ' - @' + username), _this.restricts.map(function (_ref4, i) {
          var label = _ref4.label,
              key = _ref4.key;
          return external__react__default.a.createElement("span", {
            className: "restr",
            key: i
          }, "".concat(label, ": "), external__react__default.a.createElement("span", null, restricts[key] ? 'off' : 'on'));
        }), external__react__default.a.createElement("span", {
          className: "restr"
        }, "Admin: ", external__react__default.a.createElement("span", null, isAdmin ? 'yes' : 'no'))));
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "noRowsRenderer", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
  ...
  _createClass(MngUsers, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      var _state = this.state,
          removePending = _state.removePending,
          avatarsPending = _state.avatarsPending,
          settingsPending = _state.settingsPending,
          filter = _state.filter;
      var mngUsers = this.props.mngUsers;
      var error = mngUsers.error,
          ids = mngUsers.ids,
          pending = mngUsers.pending,
          hasMore = mngUsers.hasMore;
      var rowHeight = 65; // height of .item

      var rowCount = ids.length;
      if (hasMore && !pending) rowCount++;
      return external__react__default.a.createElement(Layout["a" /* default */], {
        restrict: true
      }, external__react__default.a.createElement(AdminRestrict["a" /* default */], null, external__react__default.a.createElement("div", {
        className: Object(external__glamor_["css"])(mng_users_style)
      }, external__react__default.a.createElement("h5", null, "Manage users"), external__react__default.a.createElement("div", {
        className: "wrap"
      }, external__react__default.a.createElement("div", {
        className: "filter"
      }, external__react__default.a.createElement("label", {
        htmlFor: "filter"
      }, "Filter users: "), external__react__default.a.createElement("input", {
        id: "filter",
        type: "text",
        value: filter,
        maxLength: "128",
      ...
      }, "Select all"), external__react__default.a.createElement("button", {
        onClick: this.clearAll,
        className: "btn-alt"
      }, "Clear all")), error && external__react__default.a.createElement("p", {
        className: "err"
      }, error), external__react__default.a.createElement("div", {
        className: "items",
        style: {
          minHeight: ids.length < 6 ? rowHeight * (rowCount || 1) : rowHeight * 6,
          maxHeight: ids.length < 4 ? rowHeight * rowCount : null
        }
      }, external__react__default.a.createElement(AutoSizer__default.a, null, function (_ref5) {
        ...
        className: "settings"
      }, external__react__default.a.createElement("h5", null, "New settings"), external__react__default.a.createElement("div", null, external__react__default.a.createElement("label", {
        htmlFor: "admin"
      }, "Admin: "), external__react__default.a.createElement("input", {
        id: "admin",
        type: "checkbox",
        checked: this.state.admin,
        onChange: this.handleSetting
      })), this.restricts.map(function (_ref6) {
        ...
        return external__react__default.a.createElement("div", {
          ...
          htmlFor: key
        }, label, ": "), external__react__default.a.createElement("input", {
          id: key,
          type: "checkbox",
          checked: _this2.state[key],
          onChange: _this2.handleSetting
        }));
      ...
      }, settingsPending ? external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 18,
        alt: true
      }) : 'Submit settings'), external__react__default.a.createElement("button", {
        className: "btn-alt",
        onClick: avatarsPending ? null : this.resetAvatars
      }, avatarsPending ? external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 18
      }) : 'Reset avatars'), external__react__default.a.createElement("button", {
        onClick: removePending ? null : this.deleteUsers
      }, removePending ? external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 18,
        alt: true
      }) : 'Delete users')))))));
    }
...
/* harmony default export */ var mng_users = __webpack_exports__["default"] = (Object(withLoginReload["a" /* default */])(Object(external__react_redux_["connect"])(function (_ref7) {
  var mngUsers = _ref7.mngUsers,
      users = _ref7.users;
  return {
    mngUsers: mngUsers,
    users: users
  };
})(mng_users_MngUsers), null, util_adminReload));
