...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comps_BubbleNav__ = __webpack_require__(45);
...
var getLabel = function getLabel(label, icon) {
  return [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__fortawesome_react_fontawesome___default.a, _extends({
    icon: icon
  }, {
    key: "i",
    style: {
...
var items = [{
  label: getLabel('Add users', 'user-plus'),
  link: '/admin/add-users'
}, {
  label: getLabel('Manage users', 'users'),
  link: '/admin/mng-users'
}, {
  label: getLabel('Contact messages', 'envelope'),
  link: '/admin/contact'
}, {
  label: getLabel('Reported posts', 'exclamation-circle'),
  link: '/admin/reported'
}, {
  label: getLabel('Archived posts', 'list'),
  link: '/admin/archived'
}];
...
var Admin = function Admin(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__comps_Layout__["a" /* default */], {
    restrict: true
  }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__comps_BubbleNav__["a" /* default */], {
    items: items,
    rowCount: 3
  }));
};
