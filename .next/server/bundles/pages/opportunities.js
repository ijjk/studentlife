...
// CONCATENATED MODULE: ./comps/opps/Opp.js




var Opp_Opp = function Opp(_ref) {
  var desc = _ref.desc,
      link = _ref.link,
      catId = _ref.catId,
      oppId = _ref.oppId,
      editOpp = _ref.editOpp,
      isAdmin = _ref.isAdmin,
      removeOpp = _ref.removeOpp,
      editingOpp = _ref.editingOpp,
      cancelEditOpp = _ref.cancelEditOpp,
      submitEditOpp = _ref.submitEditOpp;
  return !editingOpp ? external__react__default.a.createElement("li", null, external__react__default.a.createElement("p", null, external__react__default.a.createElement(ExtLink["a" /* default */], {
    href: link
  }, desc)), isAdmin && [external__react__default.a.createElement(react_fontawesome__default.a, {
    key: "e",
    id: oppId,
    icon: "pencil-alt",
    onClick: editOpp
    ...
    className: "offscreen",
    htmlFor: "editDesc".concat(catId)
  }, "Opportunity description"), external__react__default.a.createElement("input", {
    type: "text",
    defaultValue: desc,
    id: "editDesc".concat(oppId)
  }), external__react__default.a.createElement("label", {
    htmlFor: "editLink".concat(catId),
    className: "offscreen"
  }, "Opportunity link"), external__react__default.a.createElement("input", {
    type: "url",
    defaultValue: link,
    id: "editLink".concat(oppId)
  }), external__react__default.a.createElement("button", {
    onClick: submitEditOpp
  }, "Update"), external__react__default.a.createElement("button", {
    onClick: cancelEditOpp,
    className: "btn-alt"
  }, "Cancel")));
};

/* harmony default export */ var opps_Opp = (Opp_Opp);
// CONCATENATED MODULE: ./comps/opps/OppCat.js
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var OppCat_OppCat = function OppCat(_ref) {
  var ids = _ref.ids,
      name = _ref.name,
      catId = _ref.catId,
      addOpp = _ref.addOpp,
      isAdmin = _ref.isAdmin,
      editCat = _ref.editCat,
      editOpp = _ref.editOpp,
      removeCat = _ref.removeCat,
      removeOpp = _ref.removeOpp,
      editingCat = _ref.editingCat,
      editingOpps = _ref.editingOpps,
      cancelEditCat = _ref.cancelEditCat,
      cancelEditOpp = _ref.cancelEditOpp,
      submitEditCat = _ref.submitEditCat,
      submitEditOpp = _ref.submitEditOpp,
      cat = _objectWithoutProperties(_ref, ["ids", "name", "catId", "addOpp", "isAdmin", "editCat", "editOpp", "removeCat", "removeOpp", "editingCat", "editingOpps", "cancelEditCat", "cancelEditOpp", "submitEditCat", "submitEditOpp"]);

  return external__react__default.a.createElement("div", {
    className: "cat"
  }, external__react__default.a.createElement("div", null, !editingCat ? external__react__default.a.createElement("div", {
    className: "title",
    id: catId
  }, external__react__default.a.createElement("h5", null, name), isAdmin && [external__react__default.a.createElement(react_fontawesome__default.a, {
    key: "e",
    onClick: editCat,
    icon: "pencil-alt"
  }), external__react__default.a.createElement(react_fontawesome__default.a, {
    ...
    className: "btn-alt"
  }, "Cancel"))), external__react__default.a.createElement("ul", null, ids.map(function (oppId) {
    var _cat$oppId = cat[oppId],
        desc = _cat$oppId.desc,
        link = _cat$oppId.link;
    var editingOpp = editingOpps[oppId];
    return external__react__default.a.createElement(opps_Opp, _extends({
      key: oppId
    }, {
      desc: desc,
      link: link,
      ...
      submitEditOpp: submitEditOpp,
      cancelEditOpp: cancelEditOpp
    }));
  })), isAdmin && external__react__default.a.createElement("div", {
    className: "addOpp"
  }, external__react__default.a.createElement("label", {
    htmlFor: "desc".concat(catId),
    className: "offscreen"
  }, "Opportunity description"), external__react__default.a.createElement("input", {
    type: "text",
    id: "desc".concat(catId),
    placeholder: "Opportunity desc"
  }), external__react__default.a.createElement("label", {
    htmlFor: "link".concat(catId),
    className: "offscreen"
  }, "Opportunity link"), external__react__default.a.createElement("input", {
    type: "url",
    id: "link".concat(catId),
...
/* harmony default export */ var opps_OppCat = (OppCat_OppCat);
// EXTERNAL MODULE: ./util/withLoginReload.js
var withLoginReload = __webpack_require__(34);

// CONCATENATED MODULE: ./pages/opportunities.js
...
function opportunities__extends() { opportunities__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return opportunities__extends.apply(this, arguments); }
...
var style = {
  ...
  '& .cats': {
    ...
    margin: 'auto',
    textAlign: 'center',
    maxWidth: theme["sizes"].maxBlockWidth * 2.25
  },
  '& .cat': (_cat = {
    margin: 25,
    textAlign: 'left',
  ...
  }, _defineProperty(_cat, theme["media"].lessThan(1100), {
    width: 'calc(100% - 50px)'
  }), _defineProperty(_cat, '& .title', _objectSpread({
    padding: '0 0 5px'
  }, theme["flexRowCenter"], {
    '& h5': {
      flexShrink: 1,
  ...
  })), _defineProperty(_cat, '& .editCat', _objectSpread({}, theme["flexRowCenter"], _defineProperty({
    flexWrap: 'wrap',
    '& button': {
      marginTop: 5,
      ':nth-child(2)': {
  ...
  }, theme["media"].lessThan(415), {
    '& input': {
      width: '100%'
    }
  }))), _defineProperty(_cat, '& ul', {
    marginLeft: 25,
    '& li': {
      padding: '8px 0 0',
      '& p, & svg': {
  ...
  }), _defineProperty(_cat, '& .addOpp', _objectSpread({
    marginTop: 15,
    flexWrap: 'wrap'
  }, theme["flexRowCenter"], {
    '& input': {
  ...
  '& .newCat': _objectSpread({}, theme["flexRowCenter"], {
    flexWrap: 'wrap',
    display: 'inline-flex',
    padding: '10px 0 0 0',
...
var opportunities_Opportunities =
/*#__PURE__*/
function (_Component) {
  ...
  function Opportunities() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Opportunities.__proto__ || Object.getPrototypeOf(Opportunities)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "addCat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var el = document.getElementById('addCat');
        var name = el.value.trim();
        if (!name.length) return;
        el.value = '';
        Object(actions["_36" /* createOppCat */])({
          name: name
        }).catch(function (err) {
          Object(actions["_88" /* setDialog */])({
            title: 'Error...',
            message: Object(getError["a" /* default */])(err, 'An error occurred adding the category'),
            button1Txt: 'OK',
            button2Txt: null
          });
        });
      ...
      writable: true,
      value: function value(e) {
        return typeof e === 'string' ? e : e.currentTarget.closest('div').id;
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "editCat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.setState({
          editingCats: _objectSpread({}, _this.state.editingCats, _defineProperty({}, id, true))
        });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "cancelEditCat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.setState({
          editingCats: _objectSpread({}, _this.state.editingCats, _defineProperty({}, id, false))
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "submitEditCat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        var _id = _this.getId(e);

        var nameEl = document.getElementById('cat' + _id);
        var name = nameEl.value.trim();
        var origName = _this.props.opps[_id].name;

        var done = function done() {
          return _this.cancelEditCat(_id);
        };

        if (name === origName) return done();
        Object(actions["_88" /* setDialog */])({
          message: "Are you sure you want to rename ".concat(origName, " to ").concat(name, "?"),
          button1Act: function button1Act() {
            Object(actions["_92" /* updateOppCat */])({
              _id: _id,
              name: name
            }).then(function () {
              return done();
              ...
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred renaming this category'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "removeCat", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        Object(actions["_88" /* setDialog */])({
          message: "Are you sure you want to delete the ".concat(_this.props.opps[id].name, " category and all it's opportunities?"),
          button1Act: function button1Act() {
            Object(actions["_80" /* removeOppCat */])(id).catch(function (err) {
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred removing the category')
              });
            });
          }
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "addOpp", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        Object(actions["_35" /* createOpp */])({
          ...
          Object(actions["_88" /* setDialog */])({
            title: 'Error...',
            message: Object(getError["a" /* default */])(err, 'An error occurred adding the opportunity'),
            button1Txt: 'OK',
            button2Txt: null
          });
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "editOpp", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.setState({
          editingOpps: _objectSpread({}, _this.state.editingOpps, _defineProperty({}, id, true))
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "cancelEditOpp", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        _this.setState({
          editingOpps: _objectSpread({}, _this.state.editingOpps, _defineProperty({}, id, false))
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "submitEditOpp", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        var cat = e.currentTarget.closest('div').getAttribute('data-cat');

        var done = function done() {
          return _this.cancelEditOpp(_id);
        };

        var descEl = document.getElementById('editDesc' + _id);
        var linkEl = document.getElementById('editLink' + _id);
        var desc = descEl.value.trim();
        var link = linkEl.value.trim();
        if (!desc.length || !link.length) return;
        var curOpp = _this.props.opps[cat][_id];
        if (desc === curOpp.desc && link === curOpp.link) return done();
        Object(actions["_88" /* setDialog */])({
          message: 'Are you sure you want to update this opportunity?',
          button1Act: function button1Act() {
            Object(actions["_91" /* updateOpp */])({
              _id: _id,
              desc: desc,
              link: link
            }).then(function () {
              ...
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred updating the opportunity'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "removeOpp", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        Object(actions["_88" /* setDialog */])({
          ...
          button1Act: function button1Act() {
            Object(actions["_79" /* removeOpp */])(id).catch(function (err) {
              Object(actions["_88" /* setDialog */])({
                title: 'Error...',
                message: Object(getError["a" /* default */])(err, 'An error occurred removing the opportunity'),
                button1Txt: 'OK',
                button2Txt: null
              });
            });
  ...
  _createClass(Opportunities, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          editingCats = _state.editingCats,
          editingOpps = _state.editingOpps;
      var _props = this.props,
          opps = _props.opps,
          users = _props.users;
      var error = opps.error,
          ids = opps.ids,
          pending = opps.pending;
      var curUser = users.curUser;
      ...
      return external__react__default.a.createElement(Layout["a" /* default */], {
        ...
        restrict: true
      }, pending && external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 36,
        className: "loading"
      }), error && !pending && external__react__default.a.createElement("p", {
        className: "error"
      }, error), !ids.length && !error && !pending && external__react__default.a.createElement("p", {
        className: "error"
      }, "There are no opportunities yet"), external__react__default.a.createElement("div", {
        className: "cats"
      }, ids.map(function (catId) {
        var cat = opps[catId];
        return external__react__default.a.createElement(opps_OppCat, opportunities__extends({
          key: catId
        }, _objectSpread({}, cat, {
          catId: catId,
          isAdmin: isAdmin,
          editingOpps: editingOpps,
          addOpp: _this2.addOpp,
          editCat: _this2.editCat,
          editOpp: _this2.editOpp,
          removeCat: _this2.removeCat,
          removeOpp: _this2.removeOpp,
          editingCat: editingCats[catId],
          cancelEditCat: _this2.cancelEditCat,
          cancelEditOpp: _this2.cancelEditOpp,
          submitEditCat: _this2.submitEditCat,
          submitEditOpp: _this2.submitEditOpp
        })));
      }), external__react__default.a.createElement("div", {
        className: "cat newCat"
      }, isAdmin && [external__react__default.a.createElement("label", {
        htmlFor: "addCat",
        key: "l"
      }, "Add category:"), external__react__default.a.createElement("input", {
        type: "text",
        id: "addCat",
        ...
        return regenerator__default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(actions["_49" /* loadOpps */])();
...
/* harmony default export */ var opportunities = __webpack_exports__["default"] = (Object(withLoginReload["a" /* default */])(Object(external__react_redux_["connect"])(function (_ref3) {
  var opps = _ref3.opps,
      users = _ref3.users;
  return {
    opps: opps,
