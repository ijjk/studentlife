...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_glamor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_glamor__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__style_theme__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_next_router__ = __webpack_require__(11);
...
var style = _objectSpread({
  ...
  '& a': _objectSpread({
    ...
    height: 135,
    padding: '0 4px'
  }, __WEBPACK_IMPORTED_MODULE_2__style_theme__["shadows"].box, __WEBPACK_IMPORTED_MODULE_2__style_theme__["flexRowCenter"], _defineProperty({
    textAlign: 'center',
    borderRadius: '100%',
    background: '#ffffff',
    display: 'inline-flex',
    ...
    '&.active': {
      ...
      '& p': _objectSpread({
        zIndex: 2,
        color: '#ffffff'
      }, __WEBPACK_IMPORTED_MODULE_2__style_theme__["shadows"].text),
      '&:before': {
        content: '""',
        position: 'absolute',
        top: -3,
        ...
        margin: 'auto',
        borderRadius: '100%',
        background: __WEBPACK_IMPORTED_MODULE_2__style_theme__["colors"].blueGradient,
        animation: "".concat(__WEBPACK_IMPORTED_MODULE_4__style_keyframes__["f" /* growIn */], " 160ms ease-in-out")
      }
    },
    ':hover': {
      borderColor: __WEBPACK_IMPORTED_MODULE_2__style_theme__["colors"].blueMix
    }
  }, __WEBPACK_IMPORTED_MODULE_2__style_theme__["media"].lessThan(330), {
    width: 110,
    height: 110,
    '&.active:before': {
      height: 115,
...
var delayNav = function delayNav(e) {
  e.preventDefault();
  ...
  var offsets = []; // get positions

  for (var i = 0; i < els.length; i++) {
    var top = els[i].offsetTop - 10.5;
    var left = els[i].offsetLeft - 10.5;
    offsets.push({
      left: left,
      top: top
    });
  ...
  for (var _i = 0; _i < els.length; _i++) {
    els[_i].style.position = 'absolute';
    els[_i].style.top = offsets[_i].top + 'px';
    els[_i].style.left = offsets[_i].left + 'px';
  } // transition position to target


  setTimeout(function () {
    for (var _i2 = 0; _i2 < els.length; _i2++) {
      els[_i2].style.top = targetTop + 'px';
      els[_i2].style.left = targetLeft + 'px';
    }

    setTimeout(function () {
      return __WEBPACK_IMPORTED_MODULE_3_next_router___default.a.push(el.href);
    }, 500);
  }, 50);
};

var BubbleNav = function BubbleNav(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
    ...
    style: {
      maxWidth: rowCount ? bubbleWidth * (rowCount + 1) : null
    }
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a", {
      ...
      onClick: delayNav,
      className: "bubble"
    }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, label));
  }));
};

/* harmony default export */ __webpack_exports__["a"] = (BubbleNav);
...
// EXTERNAL MODULE: ./comps/BubbleNav.js
var BubbleNav = __webpack_require__(45);
...
// CONCATENATED MODULE: ./comps/resources/ResourceField.js
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var ResourceField_ResourceField = function ResourceField(_ref) {
  var id = _ref.id,
      label = _ref.label,
      link = _ref.link,
      ...
      delAct = _ref.delAct,
      resetAct = _ref.resetAct,
      props = _objectWithoutProperties(_ref, ["id", "label", "link", "noIcons", "changed", "delAct", "resetAct"]);

  return external__react__default.a.createElement("div", {
    className: "row"
  }, !noIcons && external__react__default.a.createElement("div", null, changed && external__react__default.a.createElement("span", {
    title: "reset changes"
    ...
    onClick: delAct
  }))), external__react__default.a.createElement("input", _extends({}, props, {
    type: "text",
    value: label,
    maxLength: "24",
    id: "label:".concat(id),
...
/* harmony default export */ var resources_ResourceField = (ResourceField_ResourceField);
// CONCATENATED MODULE: ./comps/resources/EditResources.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function EditResources__extends() { EditResources__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return EditResources__extends.apply(this, arguments); }
...
var style = {
  ...
  '& .row, & .wrapBtn': {
    width: '100%',
    maxWidth: theme["sizes"].maxBlockWidth * 1.5
  },
  '& .wrapBtn': {
    margin: 'auto',
    textAlign: 'right',
...
var EditResources_EditResources =
/*#__PURE__*/
function (_Component) {
  _inherits(EditResources, _Component);

  function EditResources(props) {
    var _this;

    _classCallCheck(this, EditResources);

    _this = _possibleConstructorReturn(this, (EditResources.__proto__ || Object.getPrototypeOf(EditResources)).call(this, props));

    EditResources__initialiseProps.call(_assertThisInitialized(_this));
    ...
    _this.state = state;
    _this.className = Object(external__glamor_["css"])(style);
    return _this;
  }

  _createClass(EditResources, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      var _state = this.state,
          newLabel = _state.newLabel,
          newLink = _state.newLink;
      var resources = this.props.resources;
      var ids = resources.ids;
      return external__react__default.a.createElement("div", {
        className: this.className
      }, external__react__default.a.createElement("div", {
        className: "wrapItems"
      }, ids.map(function (id) {
        var _this2$state$id = _this2.state[id],
            label = _this2$state$id.label,
            link = _this2$state$id.link,
            changed = _this2$state$id.changed;
        return external__react__default.a.createElement(resources_ResourceField, EditResources__extends({
          id: id,
          changed: changed,
          label: label,
          link: link
          ...
          key: id,
          delAct: _this2.delResource,
          onChange: _this2.handleChange,
          resetAct: _this2.resetResource
        }));
      }), external__react__default.a.createElement("div", {
        className: "wrapBtn"
      }, external__react__default.a.createElement("button", {
        onClick: this.submitChanges
      }, "Submit changes"))), external__react__default.a.createElement("div", {
        className: "addItem"
      }, external__react__default.a.createElement(resources_ResourceField, {
        id: "new",
        noIcons: true,
        link: newLink,
        label: newLabel,
    ...
    value: function getDerivedStateFromProps(_ref, state) {
      ...
      resources.ids.forEach(function (id) {
        if (!state[id]) {
          hasNew = true;
          toAdd[id] = _objectSpread({}, resources[id]);
        }
      });
...
var EditResources__initialiseProps = function _initialiseProps() {
  var _this3 = this;
  ...
  Object.defineProperty(this, "handleChange", {
    ...
    value: function value(e) {
      ...
      var changed = Boolean(id !== 'new' && val !== _this3.props.resources[id][field]);

      _this3.setState(_defineProperty({}, id, _objectSpread({}, _this3.state[id], _defineProperty({
        changed: changed
      }, field, val))));
    }
  });
  Object.defineProperty(this, "resetResource", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(e) {
      ...
      _this3.setState(_defineProperty({}, id, _objectSpread({}, _this3.props.resources[id], {
        changed: false
      })));
    }
  });
  Object.defineProperty(this, "addResource", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      var _ref3 = _this3.state.new || {},
          label = _ref3.label,
          link = _ref3.link;
      ...
      Object(actions["_88" /* setDialog */])({
        ...
        button1Act: function button1Act() {
          Object(actions["_38" /* createResource */])({
            label: label,
            link: link
          }).catch(function (err) {
            Object(actions["_88" /* setDialog */])({
              title: 'Error...',
              message: Object(getError["a" /* default */])(err, 'An error occurred adding the resource'),
              button1Txt: 'OK',
              button2Txt: null
            });
          });
  ...
  Object.defineProperty(this, "delResource", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(e) {
      var resources = _this3.props.resources;
      var id = e.currentTarget.id;
      Object(actions["_88" /* setDialog */])({
        message: "Are you sure you want to delete the ".concat(resources[id].label, " resource?"),
        button1Act: function button1Act() {
          Object(actions["_83" /* removeResource */])(id).catch(function (err) {
            Object(actions["_88" /* setDialog */])({
              title: 'Error...',
              message: Object(getError["a" /* default */])(err, 'An error occurred deleting the resource'),
              button1Txt: 'OK',
              button2Txt: null
            });
          });
  ...
  Object.defineProperty(this, "updateOne", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(toUpdate) {
      if (!toUpdate.length) return Promise.resolve();

      var _id = toUpdate.pop();

      var _this3$state$_id = _this3.state[_id],
          link = _this3$state$_id.link,
          label = _this3$state$_id.label;
      return Object(actions["_95" /* updateResource */])({
        _id: _id,
        label: label,
        link: link
      }).then(function () {
        return _this3.setState(_defineProperty({}, _id, {
          link: link,
          label: label,
          changed: false
        }));
      }).then(function () {
        return _this3.updateOne(toUpdate);
      }).catch(function (err) {
        Object(actions["_88" /* setDialog */])({
          title: 'Error...',
          message: Object(getError["a" /* default */])(err, 'An error occurred submitting the changes'),
          button1Txt: 'OK',
          button2Txt: null
        });
      });
  ...
  Object.defineProperty(this, "submitChanges", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value() {
      var ids = Object.keys(_this3.state);
      var changed = ids.filter(function (id) {
        var _this3$state$id = _this3.state[id],
            changed = _this3$state$id.changed,
            link = _this3$state$id.link,
            label = _this3$state$id.label;
        return changed && link.length && label.length && id !== 'new';
      });
      if (!changed.length) return;
      var num = changed.length;
      var s = num === 1 ? '' : 's';
      Object(actions["_88" /* setDialog */])({
        message: "Are you sure you want to update ".concat(num, " resource").concat(s, "?"),
        button1Act: function button1Act() {
          return _this3.updateOne(changed);
        }
      });
    }
  });
...
/* harmony default export */ var resources_EditResources = (Object(external__react_redux_["connect"])(function (_ref2) {
  var resources = _ref2.resources;
  return {
    resources: resources
  };
})(EditResources_EditResources));
// CONCATENATED MODULE: ./pages/resource.js


function resource__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { resource__typeof = function _typeof(obj) { return typeof obj; }; } else { resource__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return resource__typeof(obj); }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step("next", value); } function _throw(err) { step("throw", err); } _next(); }); }; }

function resource__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function resource__possibleConstructorReturn(self, call) { if (call && (resource__typeof(call) === "object" || typeof call === "function")) { return call; } return resource__assertThisInitialized(self); }

function resource__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function resource__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function resource__createClass(Constructor, protoProps, staticProps) { if (protoProps) resource__defineProperties(Constructor.prototype, protoProps); if (staticProps) resource__defineProperties(Constructor, staticProps); return Constructor; }

function resource__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
/*#__PURE__*/
function (_Component) {
  resource__inherits(Resources, _Component);

  resource__createClass(Resources, null, [{
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return Object(actions["_52" /* loadResources */])();
  ...
  function Resources(props) {
    ...
    resource__classCallCheck(this, Resources);

    _this = resource__possibleConstructorReturn(this, (Resources.__proto__ || Object.getPrototypeOf(Resources)).call(this, props));
    _this.className = Object(external__glamor_["css"])(resource_style);
    return _this;
  }

  resource__createClass(Resources, [{
    key: "render",
    value: function render() {
      var _props = this.props,
      ...
      var error = resources.error,
          ids = resources.ids,
          pending = resources.pending;
      var found = Boolean(resources[active]);
      return external__react__default.a.createElement(Layout["a" /* default */], {
        className: this.className,
        restrict: true
      }, editMode && isAdmin && external__react__default.a.createElement(resources_EditResources, null), editMode && !isAdmin && external__react__default.a.createElement("p", {
        className: "error"
      }, "You do not have permission to access this"), active && found && external__react__default.a.createElement("div", null, external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 36,
        className: "loading"
      }), external__react__default.a.createElement("iframe", {
        src: resources[active].link
      })), active && !found && external__react__default.a.createElement("p", {
        className: "error"
      }, "Resource not found"), !active && !editMode && external__react__default.a.createElement("div", null, isAdmin && external__react__default.a.createElement("div", {
        className: "wrapEdit"
      }, external__react__default.a.createElement(link__default.a, {
        href: "/resource?edit"
      }, external__react__default.a.createElement("button", {
        id: "edit"
      }, "Edit resources"))), pending && external__react__default.a.createElement(Spinner["a" /* default */], {
        size: 36
      }), error && !pending && external__react__default.a.createElement("p", {
        className: "error"
      }, error), !pending && !ids.length && external__react__default.a.createElement("p", {
        className: "error"
      }, "There are items here yet"), external__react__default.a.createElement(BubbleNav["a" /* default */], {
        items: ids.map(function (id) {
          return {
            label: resources[id].label,
            link: "/resource?id=".concat(id)
          };
        })
      })));
    }
...
/* harmony default export */ var resource = __webpack_exports__["default"] = (Object(withLoginReload["a" /* default */])(Object(external__react_redux_["connect"])(function (_ref3) {
...
})(resource_Resources), function (ctx) {
  return {
    query: ctx.query
  };
}));
