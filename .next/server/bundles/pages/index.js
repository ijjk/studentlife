...
// CONCATENATED MODULE: ./comps/Slideshow.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var fadeLen = 350; // in milliseconds

var slideLen = 3250; // in milliseconds

var toggleWidth = 35; // in px

var style = Object(external__glamor_["css"])(_objectSpread({}, theme["flexRowCenter"], {
  margin: 'auto',
  maxWidth: 500,
  userSelect: 'none',
  position: 'relative',
  '& .wrapSlide': _objectSpread({}, theme["flexRowCenter"], {
    width: '100%',
    '& .adv, & .prev': {
      width: toggleWidth,
      textAlign: 'center',
      '& svg': _objectSpread({}, theme["noTapHighlight"], {
        cursor: 'pointer',
        padding: 3,
        ':hover': {
          opacity: 0.8
    ...
    '& .slide .wrap': {
      ...
      textAlign: 'center',
      position: 'relative',
      animation: "".concat(keyframes["d" /* fadeIn */], " ").concat(fadeLen, "ms ease-in-out forwards"),
      '&.doFade': {
        animation: "".concat(keyframes["e" /* fadeOut */], " ").concat(fadeLen, "ms ease-in-out forwards")
      },
      '& img': {
        maxWidth: '95%',
  ...
  '& .wrapProg': {
    ...
    '& .dots': {
      ...
      '& div': {
        ...
        opacity: 0.65,
        cursor: 'pointer',
        transition: "opacity ".concat(fadeLen, "ms ease-in-out"),
    ...
    '& .progress': {
      ...
      '&.active': {
        '& .clip': {
          transform: 'rotate(180deg)',
          animation: "".concat(keyframes["g" /* progClipRotate */], " ").concat(slideLen, "ms 1")
        },
        '& .right': {
          transform: 'rotate(135deg)',
          animation: "".concat(keyframes["h" /* progRotateRight */], " ").concat(slideLen / 2, "ms linear 2")
        },
        '& .left': {
          opacity: 1,
          animation: "".concat(keyframes["i" /* progShowLeft */], " ").concat(slideLen, "ms 1")
        }
      } // .active
...
function (_Component) {
  ...
  function Slideshow() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Slideshow.__proto__ || Object.getPrototypeOf(Slideshow)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "swapSlide", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(nextIdx) {
        clearTimeout(_this.slideTime);
        ...
        _this.slideTime = setTimeout(function () {
          _this.setState({
            active: nextIdx
          });
      ...
      value: function value(e) {
        ...
        _this.swapSlide(nextIdx);
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "dotClick", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        var el = e.target;
        var active = _this.state.active;
        var nextIdx = parseInt(el.getAttribute('id'), 10);
        if (active === nextIdx) return;

        _this.swapSlide(nextIdx);
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "startNextTime", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        clearTimeout(_this.nextSlideTime);
        _this.nextSlideTime = setTimeout(function () {
          _this.toggle(true);
        }, slideLen);
      }
    }), _temp));
  ...
  _createClass(Slideshow, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          doFade = _state.doFade,
          progClass = _state.progClass;
      var _props = this.props,
      ...
      return external__react__default.a.createElement("div", {
        ...
        className: "prev"
      }, external__react__default.a.createElement(react_fontawesome__default.a, _extends({
        icon: "chevron-left"
      }, toggleProps))), external__react__default.a.createElement("div", {
        className: "slide"
      }, external__react__default.a.createElement("div", {
        className: 'wrap' + (doFade ? ' doFade' : '')
      ...
      }), slides[active].alt && slides[active].alt.length > 0 ? external__react__default.a.createElement("div", null, slides[active].alt) : null)), external__react__default.a.createElement("div", {
        className: "adv"
      }, external__react__default.a.createElement(react_fontawesome__default.a, _extends({
        icon: "chevron-right"
      }, toggleProps)))), external__react__default.a.createElement("div", {
        ...
        return external__react__default.a.createElement("div", {
          key: i,
          id: i,
          onClick: _this2.dotClick,
          className: active === i && !doFade ? 'active' : null
        });
      })), external__react__default.a.createElement("div", {
        className: 'progress ' + progClass
      }, external__react__default.a.createElement("div", {
        className: "clip"
      }, external__react__default.a.createElement("div", {
...
/* harmony default export */ var comps_Slideshow = (Slideshow_Slideshow);
// CONCATENATED MODULE: ./comps/forms/Toggle.js
function Toggle__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { Toggle__defineProperty(target, key, source[key]); }); } return target; }

function Toggle__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }




var toggleStyle = Object(external__glamor_["css"])(Toggle__objectSpread({
  height: 40,
  width: '90%',
  maxWidth: 250,
  margin: 'auto',
  borderRadius: 25
}, theme["shadows"].insetBox, {
  position: 'relative',
  background: theme["colors"].blueMix,
  '& .slider': Toggle__objectSpread({
    position: 'absolute',
    top: 5,
    zIndex: 0,
    height: 30,
    ...
    borderRadius: 15,
    background: theme["colors"].dullWhite,
  ...
  // .slider
  '& div': Toggle__objectSpread({}, theme["flexRowCenter"], {
    position: 'relative',
    display: 'inline-flex',
    justifyContent: 'center'
  }, theme["shadows"].text, theme["noTapHighlight"], {
    color: '#ffffff',
    width: '50%',
    height: '100%',
    zIndex: 1,
...
var Toggle_Toggle = function Toggle(_ref) {
  ...
  return external__react__default.a.createElement("div", {
    ...
    className: 'slider ' + (!activeOption ? 'left' : 'right')
  }), options.map(function (option, i) {
    return external__react__default.a.createElement("div", {
      key: option,
      onClick: onToggle,
      className: i === activeOption ? 'active' : null
    }, external__react__default.a.createElement("span", null, option));
  }));
};

/* harmony default export */ var forms_Toggle = (Toggle_Toggle);
// EXTERNAL MODULE: external "next/router"
var router_ = __webpack_require__(11);
var router__default = /*#__PURE__*/__webpack_require__.n(router_);
...
// EXTERNAL MODULE: ./comps/forms/Form.js
var Form = __webpack_require__(28);

// EXTERNAL MODULE: ./comps/forms/Field.js
var Field = __webpack_require__(29);

// EXTERNAL MODULE: ./util/getError.js
var getError = __webpack_require__(8);

// CONCATENATED MODULE: ./comps/forms/SetupForm.js
function SetupForm__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SetupForm__typeof = function _typeof(obj) { return typeof obj; }; } else { SetupForm__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SetupForm__typeof(obj); }

function SetupForm__extends() { SetupForm__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return SetupForm__extends.apply(this, arguments); }

function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function SetupForm__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function SetupForm__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SetupForm__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SetupForm__createClass(Constructor, protoProps, staticProps) { if (protoProps) SetupForm__defineProperties(Constructor.prototype, protoProps); if (staticProps) SetupForm__defineProperties(Constructor, staticProps); return Constructor; }

function SetupForm__possibleConstructorReturn(self, call) { if (call && (SetupForm__typeof(call) === "object" || typeof call === "function")) { return call; } return SetupForm__assertThisInitialized(self); }

function SetupForm__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function SetupForm__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var fieldKeys = ['firstName', 'lastName', 'username', 'email', 'password', 'confPassword'];

var SetupForm_LoginForm =
/*#__PURE__*/
function (_Component) {
  SetupForm__inherits(LoginForm, _Component);

  function LoginForm() {
    var _this;

    SetupForm__classCallCheck(this, LoginForm);

    _this = SetupForm__possibleConstructorReturn(this, (LoginForm.__proto__ || Object.getPrototypeOf(LoginForm)).call(this));
    Object.defineProperty(SetupForm__assertThisInitialized(_this), "toggleShowPass", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    Object.defineProperty(SetupForm__assertThisInitialized(_this), "handleChange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        _this.setState(SetupForm__defineProperty({}, e.target.id, e.target.value));
      }
    });
    Object.defineProperty(SetupForm__assertThisInitialized(_this), "submit", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        var missingField;
        var hasMissing = fieldKeys.some(function (f) {
          var field = fields[f];

          var val = _this.state[f].trim();
        ...
        var err = function err(createError) {
          return _this.setState({
        ...
        if (hasMissing) return err("".concat(missingField, " is required"));
        ...
        Object(actions["_40" /* createUser */])(data).then(function () {
          return Object(actions["_55" /* login */])({
            email: data.email,
            password: data.password
          });
        }).then(function () {
          return router__default.a.push('/home');
        }).catch(function (error) {
          return err(Object(getError["a" /* default */])(error));
        });
      }
    });
    var state = {
  ...
  SetupForm__createClass(LoginForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external__react__default.a.createElement(Form["a" /* default */], SetupForm__extends({
        submit: this.submit,
        head: external__react__default.a.createElement("h4", null, "Setup account")
      }, {
        maxWidth: maxWidth,
        className: className,
        error: createError || users.error,
        pending: createPending || users.pending
      }), fieldKeys.map(function (f) {
        var _fields$f = fields[f],
            label = _fields$f.label,
            field = _objectWithoutProperties(_fields$f, ["label"]);

        if (field.type === 'password') {
          field.icon = 'lock';
          field.type = showPass ? 'text' : 'password';
          field.extraIcon = showPass ? 'eye-slash' : 'eye';
          field.extraIconProps = {
            onClick: _this2.toggleShowPass
          };
        }

        return external__react__default.a.createElement(Field["a" /* default */], SetupForm__extends({}, field, {
          key: f,
          name: f,
          placeholder: label,
...
/* harmony default export */ var SetupForm = (Object(external__react_redux_["connect"])(function (_ref) {
  var users = _ref.users;
  return {
    users: users
  };
...
// EXTERNAL MODULE: ./comps/forms/LoginForm.js
var forms_LoginForm = __webpack_require__(30);

// EXTERNAL MODULE: ./util/config.js
var config = __webpack_require__(5);
var config_default = /*#__PURE__*/__webpack_require__.n(config);

// CONCATENATED MODULE: ./comps/forms/ContactForm.js
function ContactForm__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ContactForm__typeof = function _typeof(obj) { return typeof obj; }; } else { ContactForm__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ContactForm__typeof(obj); }

function ContactForm__extends() { ContactForm__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ContactForm__extends.apply(this, arguments); }

function ContactForm__objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function ContactForm__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function ContactForm__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ContactForm__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ContactForm__createClass(Constructor, protoProps, staticProps) { if (protoProps) ContactForm__defineProperties(Constructor.prototype, protoProps); if (staticProps) ContactForm__defineProperties(Constructor, staticProps); return Constructor; }

function ContactForm__possibleConstructorReturn(self, call) { if (call && (ContactForm__typeof(call) === "object" || typeof call === "function")) { return call; } return ContactForm__assertThisInitialized(self); }

function ContactForm__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function ContactForm__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var ContactForm_fields = {
  ...
  msg: {
    ...
    type: 'textarea',
    label: 'Your message',
    maxLength: config["maxContactMsg"]
  }
};
var ContactForm_fieldKeys = ['name', 'email', 'confEmail', 'msg'];

var ContactForm_ContactForm =
/*#__PURE__*/
function (_Component) {
  ContactForm__inherits(ContactForm, _Component);

  function ContactForm() {
    var _this;

    ContactForm__classCallCheck(this, ContactForm);

    _this = ContactForm__possibleConstructorReturn(this, (ContactForm.__proto__ || Object.getPrototypeOf(ContactForm)).call(this));
    Object.defineProperty(ContactForm__assertThisInitialized(_this), "handleChange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        _this.setState(ContactForm__defineProperty({}, e.target.id, e.target.value));
      }
    });
    Object.defineProperty(ContactForm__assertThisInitialized(_this), "submit", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        ...
        var data = {};
        var missingField;
        var hasMissing = ContactForm_fieldKeys.some(function (f) {
          var field = ContactForm_fields[f];
        ...
        Object(actions["_33" /* createContact */])(data).then(function () {
          var cleanState = {
            pending: false,
            error: 'Message sent successfully'
          };
          ContactForm_fieldKeys.forEach(function (f) {
            return cleanState[f] = '';
          });

          _this.setState(cleanState);
        }).catch(function (error) {
          return err(Object(getError["a" /* default */])(error));
        });
      }
  ...
  ContactForm__createClass(ContactForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      var _props = this.props,
          maxWidth = _props.maxWidth,
          className = _props.className;
      return external__react__default.a.createElement(Form["a" /* default */], ContactForm__extends({
        submit: this.submit
      }, {
        error: error,
        pending: pending,
        maxWidth: maxWidth,
        className: className
      }), ContactForm_fieldKeys.map(function (f) {
        var _fields$f = ContactForm_fields[f],
            label = _fields$f.label,
            field = ContactForm__objectWithoutProperties(_fields$f, ["label"]);

        return external__react__default.a.createElement(Field["a" /* default */], ContactForm__extends({}, field, {
          key: f,
          name: f,
          placeholder: label,
          value: _this2.state[f],
...
/* harmony default export */ var forms_ContactForm = (ContactForm_ContactForm);
...
var indexStyle = Object(external__glamor_["css"])(pages__objectSpread({}, theme["flexRowCenter"], pages__defineProperty({
  '& .wrapSlideshow, & .wrapForm': {
    width: '50%',
    padding: '20px 0'
  }
}, theme["media"].lessThan(850), {
  '& .wrapSlideshow': {
    display: 'none'
  },
  '& .wrapForm': {
...
function (_Component) {
  ...
  function IndexPage() {
    ...
    return pages__possibleConstructorReturn(_this, (_temp = _this = pages__possibleConstructorReturn(this, (_ref2 = IndexPage.__proto__ || Object.getPrototypeOf(IndexPage)).call.apply(_ref2, [this].concat(args))), Object.defineProperty(pages__assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(pages__assertThisInitialized(_this), "checkSlideshow", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var showSlideshow = _this.state.showSlideshow;
    ...
    }), Object.defineProperty(pages__assertThisInitialized(_this), "handleToggle", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var curOption = _this.state.curOption ? 0 : 1;
  ...
  pages__createClass(IndexPage, [{
    ...
    key: "render",
    value: function render() {
      var doSetup = this.props.users.doSetup;
      var _state = this.state,
          curForm = _state.curForm,
          curOption = _state.curOption,
          formShouldHide = _state.formShouldHide,
          initial = _state.initial,
          showSlideshow = _state.showSlideshow;
      var formClass = '';
      ...
      return external__react__default.a.createElement(Layout["a" /* default */], {
        ...
        basicHeader: true,
        noNav: true
      }, showSlideshow ? external__react__default.a.createElement("div", {
        className: "wrapSlideshow"
      }, external__react__default.a.createElement(comps_Slideshow, pages__extends({
        slides: pages_slides
      }, {
        height: 300
      }))) : null, external__react__default.a.createElement("div", {
        className: "wrapForm"
      }, doSetup ? external__react__default.a.createElement(SetupForm, {
        maxWidth: formWidth
      }) : [external__react__default.a.createElement(forms_Toggle, {
        options: ['Sign in', 'Contact'],
        activeOption: curOption,
        onToggle: this.handleToggle,
        maxWidth: formWidth,
        key: "1"
      }), curForm === 0 ? external__react__default.a.createElement(forms_LoginForm["a" /* default */], {
        key: "2",
        maxWidth: formWidth,
        className: formClass + 'Left',
        redirect: true
      }) : external__react__default.a.createElement(forms_ContactForm, {
        key: "3",
        maxWidth: formWidth,
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (Object(external__react_redux_["connect"])(function (_ref3) {
  var users = _ref3.users;
  return {
    users: users
  };
